...
let cvcWidgetResponseTimeoutMs = 10000
  ...
  ->then(customerDetails => {
    ...
    let confirmWithCVCWidget = (
      ...
      Promise.make((resolve, _) => {
        ...
        // Timeout fallback: if the CVC widget iframe does not respond within the configured timeout
          ...
          () => {
            ...
            resolve(
              handleFailureResponse(
                ...
                ~errorType="cvc_widget_timeout",
              ),
            )
          },
          cvcWidgetResponseTimeoutMs,
        )->ignore
      })
    }
