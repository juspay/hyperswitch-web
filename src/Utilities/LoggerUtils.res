...
> =>
  ...
  | VISA_UCTP_LOAD_SCRIPT_RETURNED
  | VISA_UCTP_INIT
  | VISA_UCTP_RETURNED
  | VISA_DCTP_INIT
  | VISA_DCTP_RETURNED
  | MASTERCARD_DCTP_INIT
  | MASTERCARD_DCTP_RETURNED
  ...
  | VISA_DCTP_ID_LOOKUP_RETURNED
  | MASTERCARD_DCTP_ID_LOOKUP_INIT
  | MASTERCARD_DCTP_ID_LOOKUP_RETURNED
  | GET_USER_TYPE
  | GET_USER_TYPE_INIT
  | GET_USER_TYPE_RETURNED
  | VISA_UCTP_GET_CARDS_INIT
  | VISA_UCTP_GET_CARDS_RETUNRED
  ...
  | VISA_UCTP_GET_CARDS_VALIDATE_RETURNED
  | CHECKOUT
  | CHECKOUT_INIT
  | CHECKOUT_RETURNED
  | CHECK_WINDOW_INIT
  | CHECK_WINDOW_RETURNED
  | CREATE_WINDOW
  | CLOSE_WINDOW
  | RECHECK_WINDOW_INIT
  | RECHECK_WINDOW_RETURNED
  | VISA_UCTP_CHECKOUT_INIT
  | VISA_UCTP_CHECKOUT_RETUNRED
