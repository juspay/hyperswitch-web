      ...
      if metaData->getString("wallet", "") === "Paze" {
        ...
        let mountPazeSDK = () => {
          ...
          SdkRuntimeLogger.logResource(
            ~event=ScriptLoad(PazeScript, Init),
            ~paymentMethod=Wallet(Paze),
            ~message="PAZE SDK Script Loading",
          )
          ...
          pazeScript->Window.elementOnerror(exn => {
            SdkRuntimeLogger.logResource(
              ...
              ~paymentMethod=Wallet(Paze),
              ~message=`Error During Loading PAZE SDK Script: ${exn
          ...
          pazeScript->Window.elementOnload(_ => {
            SdkRuntimeLogger.logResource(
              ~event=ScriptLoad(PazeScript, Done),
              ~paymentMethod=Wallet(Paze),
              ~message="PAZE SDK Script Loaded",
            )
            loadPazeSDK()->ignore
          })
