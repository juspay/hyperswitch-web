let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  cardHolderNameRequiredText: `Kortinnehavarens namn krävs`,
  lastNameRequiredText: `Efternamn krävs`,
  mandatoryFieldText: `Detta fält är obligatoriskt`,
  phoneInvalidText: `Ange ett giltigt telefonnummer`,
  blikCodeInvalidText: `Ange en giltig 6-siffrig Blik-kod`,
  ...
  selectNamedPaymentMethodLabel: name => `Välj betalningsmetod ${name}`,
  ...
  paymentDetailsFormLabel: "Formulär för betalningsuppgifter",
  goBackLabel: "Gå tillbaka",
  openBankAccountOptionsLabel: "Öppna bankkontovalternativ",
  addBankAccountLabel: "Klicka för att lägga till bankkonto",
  toggleInstallmentOptionsLabel: "Växla alternativ för avbetalningsplan",
  savePaymentMethodLabel: "Spara betalningsmetod",
  deletePaymentMethodLabel: "Ta bort betalningsmetod",
  managePaymentMethodsLabel: "Hantera betalningsmetoder",
  selectPaymentMethodLabel: "Välj betalningsmetod",
  doneLabel: "Klar",
  selectCardLabel: (nickname, last4) => `Välj kort ${nickname} som slutar på ${last4}`,
  selectInstallmentPlanLabel: count => `Välj avbetalningsplan med ${count} delbetalningar`,
}
