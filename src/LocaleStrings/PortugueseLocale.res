let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  phoneInvalidText: `Insira um número de telefone válido`,
  blikCodeInvalidText: `Insira um código Blik válido de 6 dígitos`,
  ...
  selectNamedPaymentMethodLabel: name => `Selecionar método de pagamento ${name}`,
  ...
  paymentDetailsFormLabel: "Formulário de detalhes de pagamento",
  goBackLabel: "Voltar",
  openBankAccountOptionsLabel: "Abrir opções de conta bancária",
  addBankAccountLabel: "Clique para adicionar conta bancária",
  toggleInstallmentOptionsLabel: "Alternar opções de plano de parcelamento",
  savePaymentMethodLabel: "Salvar método de pagamento",
  deletePaymentMethodLabel: "Excluir método de pagamento",
  managePaymentMethodsLabel: "Gerenciar métodos de pagamento",
  selectPaymentMethodLabel: "Selecionar método de pagamento",
  doneLabel: "Concluído",
  selectCardLabel: (nickname, last4) => `Selecionar cartão ${nickname} terminando em ${last4}`,
  selectInstallmentPlanLabel: count => `Selecionar plano de parcelamento com ${count} parcelas`,
}
