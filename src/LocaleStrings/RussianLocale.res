let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  savePaymentDetails: `Безопасно сохранить мои платежные данные для более быстрых платежей`,
  savePaymentDetailsWhereverPossible: `Безопасно сохранить мои платежные данные для более быстрых платежей, если доступно`,
  ...
  phoneInvalidText: `Введите действительный номер телефона`,
  blikCodeInvalidText: `Введите действительный 6-значный код Blik`,
