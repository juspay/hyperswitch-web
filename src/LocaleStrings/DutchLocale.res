let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  mandatoryFieldText: `Dit veld is verplicht`,
  phoneInvalidText: `Voer een geldig telefoonnummer in`,
  blikCodeInvalidText: `Voer een geldige 6-cijferige Blik-code in`,
  ...
  selectNamedPaymentMethodLabel: name => `Selecteer ${name} betaalmethode`,
  processingPaymentText: "Betaling verwerken",
  paymentFailedText: "Betaling mislukt. Controleer uw gegevens en probeer het opnieuw.",
  paymentDetailsFormLabel: "Formulier betalingsgegevens",
  goBackLabel: "Ga terug",
  openBankAccountOptionsLabel: "Bankrekening opties openen",
  addBankAccountLabel: "Klik om bankrekening toe te voegen",
  toggleInstallmentOptionsLabel: "Termijnbetalingsopties in-/uitschakelen",
  savePaymentMethodLabel: "Betaalmethode opslaan",
  deletePaymentMethodLabel: "Betaalmethode verwijderen",
  managePaymentMethodsLabel: "Betaalmethoden beheren",
  selectPaymentMethodLabel: "Selecteer betaalmethode",
  doneLabel: "Klaar",
  selectCardLabel: (nickname, last4) => `Selecteer kaart ${nickname} eindigend op ${last4}`,
  selectInstallmentPlanLabel: count => `Selecteer termijnplan met ${count} termijnen`,
}
