let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  selectNamedPaymentMethodLabel: name => `اختر طريقة الدفع ${name}`,
  processingPaymentText: "جارٍ معالجة الدفع",
  paymentFailedText: "فشل الدفع. يرجى مراجعة التفاصيل والمحاولة مجددًا.",
  paymentDetailsFormLabel: "نموذج تفاصيل الدفع",
  goBackLabel: "العودة",
  openBankAccountOptionsLabel: "فتح خيارات الحساب البنكي",
  addBankAccountLabel: "انقر لإضافة حساب بنكي",
  toggleInstallmentOptionsLabel: "تبديل خيارات خطة التقسيط",
  savePaymentMethodLabel: "حفظ طريقة الدفع",
  deletePaymentMethodLabel: "حذف طريقة الدفع",
  managePaymentMethodsLabel: "إدارة طرق الدفع",
  selectPaymentMethodLabel: "اختر طريقة الدفع",
  doneLabel: "تم",
  selectCardLabel: (nickname, last4) =>
    `اختر البطاقة ${nickname} المنتهية بـ ${last4}`,
  selectInstallmentPlanLabel: count => `اختر خطة التقسيط بـ ${count} أقساط`,
}
