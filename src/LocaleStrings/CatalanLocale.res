let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  copiedText: `Copiat!`,
  copyText: `Copiar`,
  copyQRDataText: `Copiar dades QR`,
  qrCodeValidityText: `El codi QR és vàlid durant els pròxims 15 minuts. No tanqueu la pàgina fins que el pagament s'hagi completat correctament; després sereu redirigit automàticament.`,
  doneText: `Fet`,
  moreText: `Més`,
  addBankDetailsConfirmText: `Si us plau, afegiu les dades bancàries i després confirmeu el pagament amb els mètodes de pagament afegits.`,
  addBankDetailsButtonText: `Afegir dades bancàries`,
  bankDebitStepsText: pmt =>
    `El dèbit bancari ${pmt} requereix 2 passos per pagar. Seguiu les instruccions:`,
  bankDebitStep1Text: `Feu clic a «Afegir dades bancàries» i procediu a afegir les dades del vostre compte bancari.`,
  bankDebitStep2Text: `Després de la verificació, veureu els vostres comptes afegits. Podeu seleccionar el compte amb el qual voleu pagar i fer clic al botó de pagament.`,
  removeAccountText: `Eliminar compte`,
  bankAccountDisplayText: last4 => `Banc  **** ${last4}`,
  microDepositsInitiatedText: `Microdipòsits iniciats`,
  microDepositsExpectText: last4 =>
    `Espereu un dipòsit de 0,01 $ al compte acabat en **** ${last4} en 1-2 dies hàbils i un correu electrònic amb instruccions addicionals per verificar el vostre compte.`,
  bankStatementDisplayText: last4 => `**** ${last4}  EXTRACTE BANCARI`,
  transactionText: `Transacció`,
  amountText: `Import`,
  typeText: `Tipus`,
  bankDetailsHeadingText: `Dades bancàries`,
  accountHolderNameLabel: `Nom del titular del compte`,
  accountHolderNamePlaceholder: `p. ex.: Joan Garcia`,
  accountTypeLabel: `Tipus de compte`,
  errorOccurredText: `S'ha produït un error`,
  bankTransferTitleText: title => `Transferència bancària ${title}`,
  useDetailsToTransferText: `Utilitzeu aquestes dades per transferir l'import`,
  bankAccountDetailsText: `Dades del compte bancari`,
  bankTransferDisclaimerText: `Preneu nota d'aquestes dades abans de tancar aquesta finestra. No podreu generar aquestes dades de nou.`,
  voucherGeneratedText: pm =>
    `El val ${pm} s'ha generat correctament! Si la descàrrega del document no s'ha iniciat automàticament, feu clic `,
  hereText: `aquí`,
  toDownloadItText: ` per descarregar-lo.`,
  barCodeReferenceText: `Referència del codi de barres: `,
  voucherDisclaimerText: `No tanqueu la pàgina fins que el val s'hagi descarregat correctament; després sereu redirigit automàticament.`,
  payWithText: `Pagar amb`,
  notYouText: `No sou vós?`,
  ctpSwitchIdentifierText: `Introduïu un nou correu electrònic o número de mòbil per accedir a un conjunt diferent de targetes vinculades.`,
  phoneLabel: `Telèfon`,
  enterEmailPlaceholder: `Introduïu el correu electrònic`,
  mobileNumberPlaceholder: `Número de mòbil`,
  switchIdButtonText: `Canviar identificador`,
  ctpConsentSharingText: (dpaName, cardBrand) =>
    `En continuar, ${dpaName} compartirà les dades de la vostra targeta, l'adreça de facturació i el correu electrònic amb ${cardBrand} per permetre-us registrar-vos de manera segura a Click to Pay per a pagaments més ràpids.`,
  learnMoreText: `Més informació`,
  ctpSaveInfoText: cardBrand => `Desar la meva informació amb ${cardBrand} `,
  ctpFasterCheckoutText: `per a un pagament més ràpid i segur`,
  ctpVerifyIdentityText: `El vostre correu electrònic o número de mòbil s'utilitzarà per verificar la vostra identitat.`,
  ctpDataRatesText: `Es poden aplicar tarifes de missatges/dades.`,
  ctpRememberMeText: `Recorda'm en aquest navegador`,
  ctpRememberMeTooltipLine1: `Quan se us recordi, ometreu la verificació i accedireu de manera segura a les vostres targetes desades en pagar amb Click to Pay.`,
  ctpRememberMeTooltipLine2: `No recomanat per a dispositius públics o compartits perquè utilitza galetes.`,
  ctpTermsConsentText: cardBrand => `En continuar, accepteu els termes de ${cardBrand} `,
  termsText: `Termes`,
  ctpPrivacyConsentText: `i enteneu que les vostres dades seran processades d'acord amb l'`,
  privacyNoticeText: `Avís de privadesa`,
  loadingText: `Carregant...`,
  processingPaymentText: `Estem processant el vostre pagament...`,
  redirectedToNewTabText: `Heu estat redirigit a una nova pestanya per completar el pagament. L'estat s'actualitzarà automàticament`,
  addNewCardText: `Afegir nova targeta`,
  somethingWentWrongText: `Ups, alguna cosa ha anat malament!`,
  selectCardBrandText: `Seleccioneu una marca de targeta`,
  saveCardText: `Desar targeta`,
  errorBackShortlyText: `Tornarem aviat :)`,
  tryAnotherPaymentMethodText: `Proveu un altre mètode de pagament :)`,
}
