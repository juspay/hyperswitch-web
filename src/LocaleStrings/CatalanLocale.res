let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  phoneInvalidText: `Introdueix un número de telèfon vàlid`,
  blikCodeInvalidText: `Introdueix un codi Blik vàlid de 6 dígits`,
  ...
  selectNamedPaymentMethodLabel: name => `Seleccionar el mètode de pagament ${name}`,
  ...
  paymentDetailsFormLabel: "Formulari de detalls de pagament",
  goBackLabel: "Tornar enrere",
  openBankAccountOptionsLabel: "Obrir opcions de compte bancari",
  addBankAccountLabel: "Feu clic per afegir un compte bancari",
  toggleInstallmentOptionsLabel: "Alternar opcions de pla de quotes",
  savePaymentMethodLabel: "Desar el mètode de pagament",
  deletePaymentMethodLabel: "Eliminar el mètode de pagament",
  managePaymentMethodsLabel: "Gestionar els mètodes de pagament",
  selectPaymentMethodLabel: "Seleccionar el mètode de pagament",
  doneLabel: "Fet",
  selectCardLabel: (nickname, last4) => `Seleccionar la targeta ${nickname} que acaba en ${last4}`,
  selectInstallmentPlanLabel: count => `Seleccionar el pla de quotes amb ${count} quotes`,
}
