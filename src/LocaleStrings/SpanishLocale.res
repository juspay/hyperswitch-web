let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  phoneInvalidText: `Introduce un número de teléfono válido`,
  blikCodeInvalidText: `Introduce un código Blik válido de 6 dígitos`,
  ...
  selectNamedPaymentMethodLabel: name => `Seleccionar método de pago ${name}`,
  processingPaymentText: "Procesando pago",
  paymentFailedText: "Pago fallido. Por favor, revise sus datos e intente de nuevo.",
  paymentDetailsFormLabel: "Formulario de detalles de pago",
  goBackLabel: "Volver",
  openBankAccountOptionsLabel: "Abrir opciones de cuenta bancaria",
  addBankAccountLabel: "Haga clic para agregar cuenta bancaria",
  toggleInstallmentOptionsLabel: "Alternar opciones de plan de cuotas",
  savePaymentMethodLabel: "Guardar método de pago",
  deletePaymentMethodLabel: "Eliminar método de pago",
  managePaymentMethodsLabel: "Gestionar métodos de pago",
  selectPaymentMethodLabel: "Seleccionar método de pago",
  doneLabel: "Listo",
  selectCardLabel: (nickname, last4) => `Seleccionar tarjeta ${nickname} que termina en ${last4}`,
  selectInstallmentPlanLabel: count => `Seleccionar plan de cuotas con ${count} cuotas`,
}
