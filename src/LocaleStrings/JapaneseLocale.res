let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  mandatoryFieldText: `この項目は必須です`,
  phoneInvalidText: `有効な電話番号を入力してください`,
  blikCodeInvalidText: `有効な6桁のBlikコードを入力してください`,
  ...
  selectNamedPaymentMethodLabel: name => `${name} の支払い方法を選択`,
  processingPaymentText: "決済処理中",
  paymentFailedText: "決済に失敗しました。内容をご確認の上、もう一度お試しください。",
  paymentDetailsFormLabel: "お支払い情報フォーム",
  goBackLabel: "戻る",
  openBankAccountOptionsLabel: "銀行口座オプションを開く",
  addBankAccountLabel: "銀行口座を追加するにはクリック",
  toggleInstallmentOptionsLabel: "分割払いプランオプションの切り替え",
  savePaymentMethodLabel: "支払い方法を保存",
  deletePaymentMethodLabel: "支払い方法を削除",
  managePaymentMethodsLabel: "支払い方法の管理",
  selectPaymentMethodLabel: "支払い方法を選択",
  doneLabel: "完了",
  selectCardLabel: (nickname, last4) => `${nickname} 末尾 ${last4} のカードを選択`,
  selectInstallmentPlanLabel: count => `${count} 回払いの分割プランを選択`,
}
