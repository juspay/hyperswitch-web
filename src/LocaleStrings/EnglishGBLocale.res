let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  blikCodeInvalidText: `Enter a valid 6-digit Blik code`,
  ...
  selectNamedPaymentMethodLabel: name => `Select ${name} payment method`,
  processingPaymentText: "Processing payment",
  paymentFailedText: "Payment failed. Please review your details and try again.",
  paymentDetailsFormLabel: "Payment Details Form",
  goBackLabel: "Go back",
  openBankAccountOptionsLabel: "Open bank account options",
  addBankAccountLabel: "Click to Add bank account",
  toggleInstallmentOptionsLabel: "Toggle installment plan options",
  savePaymentMethodLabel: "Save payment method",
  deletePaymentMethodLabel: "Delete payment method",
  managePaymentMethodsLabel: "Manage payment methods",
  selectPaymentMethodLabel: "Select payment method",
  doneLabel: "Done",
  selectCardLabel: (nickname, last4) => `Select card ${nickname} ending ${last4}`,
  selectInstallmentPlanLabel: count => `Select installment plan with ${count} installments`,
}
