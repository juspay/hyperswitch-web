let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  mandatoryFieldText: `此欄位為必填`,
  phoneInvalidText: `請輸入有效的電話號碼`,
  blikCodeInvalidText: `請輸入有效的 6 位數 Blik 代碼`,
  ...
  selectNamedPaymentMethodLabel: name => `選擇 ${name} 付款方式`,
  processingPaymentText: "正在處理付款",
  paymentFailedText: "付款失敗。請檢查您的詳細信息並重試。",
  paymentDetailsFormLabel: "付款詳情表單",
  goBackLabel: "返回",
  openBankAccountOptionsLabel: "開啟銀行帳戶選項",
  addBankAccountLabel: "點擊以添加銀行帳戶",
  toggleInstallmentOptionsLabel: "切換分期付款計劃選項",
  savePaymentMethodLabel: "保存付款方式",
  deletePaymentMethodLabel: "刪除付款方式",
  managePaymentMethodsLabel: "管理付款方式",
  selectPaymentMethodLabel: "選擇付款方式",
  doneLabel: "完成",
  selectCardLabel: (nickname, last4) => `選擇尾號 ${last4} 的 ${nickname} 卡`,
  selectInstallmentPlanLabel: count => `選擇 ${count} 期分期付款計劃`,
}
