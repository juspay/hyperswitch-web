let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  phoneInvalidText: `Inserisci un numero di telefono valido`,
  blikCodeInvalidText: `Inserisci un codice Blik valido di 6 cifre`,
  ...
  selectNamedPaymentMethodLabel: name => `Seleziona il metodo di pagamento ${name}`,
  ...
  paymentDetailsFormLabel: "Modulo dettagli pagamento",
  goBackLabel: "Torna indietro",
  openBankAccountOptionsLabel: "Apri le opzioni del conto bancario",
  addBankAccountLabel: "Clicca per aggiungere un conto bancario",
  toggleInstallmentOptionsLabel: "Attiva/disattiva le opzioni del piano rateale",
  savePaymentMethodLabel: "Salva metodo di pagamento",
  deletePaymentMethodLabel: "Elimina metodo di pagamento",
  managePaymentMethodsLabel: "Gestisci i metodi di pagamento",
  selectPaymentMethodLabel: "Seleziona metodo di pagamento",
  doneLabel: "Fatto",
  selectCardLabel: (nickname, last4) => `Seleziona la carta ${nickname} che termina con ${last4}`,
  selectInstallmentPlanLabel: count => `Seleziona il piano rateale con ${count} rate`,
}
