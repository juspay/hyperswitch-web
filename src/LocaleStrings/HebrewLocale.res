let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  phoneInvalidText: `הזן מספר טלפון תקין`,
  blikCodeInvalidText: `הזן קוד Blik תקין בן 6 ספרות`,
  ...
  selectNamedPaymentMethodLabel: name => `בחר אמצעי תשלום ${name}`,
  processingPaymentText: "מעבד תשלום",
  paymentFailedText: "התשלום נכשל. אנא בדוק את פרטיך ונסה שוב.",
  paymentDetailsFormLabel: "טופס פרטי תשלום",
  goBackLabel: "חזור",
  openBankAccountOptionsLabel: "פתח אפשרויות חשבון בנק",
  addBankAccountLabel: "לחץ להוספת חשבון בנק",
  toggleInstallmentOptionsLabel: "הצג/הסתר אפשרויות תוכנית תשלומים",
  savePaymentMethodLabel: "שמור אמצעי תשלום",
  deletePaymentMethodLabel: "מחק אמצעי תשלום",
  managePaymentMethodsLabel: "נהל אמצעי תשלום",
  selectPaymentMethodLabel: "בחר אמצעי תשלום",
  doneLabel: "סיום",
  selectCardLabel: (nickname, last4) => `בחר כרטיס ${nickname} המסתיים ב-${last4}`,
  selectInstallmentPlanLabel: count =>
    `בחר תוכנית תשלומים עם ${count} תשלומים`,
}
