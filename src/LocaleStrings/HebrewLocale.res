let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  formFieldCardExpDateLabel: "תאריך תפוגה",
  ...
  formFieldCardExpDatePlaceholder: "חודש / שנה",
  ...
  formFieldCountryCodePlaceholder: "מדינה",
  ...
  payoutStatusFailedText: "תשלום מוצלח",
  payoutStatusPendingText: "תשלום בתהליך",
  payoutStatusSuccessText: "תשלום נכשל",
}
