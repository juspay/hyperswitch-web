let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  blikCodeInvalidText: `Wprowadź prawidłowy 6-cyfrowy kod Blik`,
  ...
  selectNamedPaymentMethodLabel: name => `Wybierz metodę płatności ${name}`,
  processingPaymentText: "Przetwarzanie płatności",
  paymentFailedText: "Płatność nieudana. Sprawdź swoje dane i spróbuj ponownie.",
  paymentDetailsFormLabel: "Formularz szczegółów płatności",
  goBackLabel: "Wróć",
  openBankAccountOptionsLabel: "Otwórz opcje konta bankowego",
  addBankAccountLabel: "Kliknij, aby dodać konto bankowe",
  toggleInstallmentOptionsLabel: "Przełącz opcje planu ratalnego",
  savePaymentMethodLabel: "Zapisz metodę płatności",
  deletePaymentMethodLabel: "Usuń metodę płatności",
  managePaymentMethodsLabel: "Zarządzaj metodami płatności",
  selectPaymentMethodLabel: "Wybierz metodę płatności",
  doneLabel: "Gotowe",
  selectCardLabel: (nickname, last4) => `Wybierz kartę ${nickname} kończącą się na ${last4}`,
  selectInstallmentPlanLabel: count => `Wybierz plan ratalny z ${count} ratami`,
}
