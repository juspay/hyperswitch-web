...
type localeStrings = {
  ...
  qrCodeValidityText: string,
  doneText: string,
  moreText: string,
  addBankDetailsConfirmText: string,
  addBankDetailsButtonText: string,
  bankDebitStepsText: string => string,
  bankDebitStep1Text: string,
  bankDebitStep2Text: string,
  removeAccountText: string,
  bankAccountDisplayText: string => string,
  microDepositsInitiatedText: string,
  microDepositsExpectText: string => string,
  bankStatementDisplayText: string => string,
  transactionText: string,
  amountText: string,
  typeText: string,
  bankDetailsHeadingText: string,
  accountHolderNameLabel: string,
  accountHolderNamePlaceholder: string,
  accountTypeLabel: string,
  errorOccurredText: string,
  bankTransferTitleText: string => string,
  useDetailsToTransferText: string,
  bankAccountDetailsText: string,
  bankTransferDisclaimerText: string,
  voucherGeneratedText: string => string,
  hereText: string,
  toDownloadItText: string,
  barCodeReferenceText: string,
  voucherDisclaimerText: string,
  payWithText: string,
  notYouText: string,
  ...
  switchIdButtonText: string,
  ctpConsentSharingText: (string, string) => string,
  learnMoreText: string,
  ctpSaveInfoText: string => string,
  ctpFasterCheckoutText: string,
  ctpVerifyIdentityText: string,
  ctpDataRatesText: string,
  ctpRememberMeText: string,
  ctpRememberMeTooltipLine1: string,
  ctpRememberMeTooltipLine2: string,
  ctpTermsConsentText: string => string,
  termsText: string,
  ctpPrivacyConsentText: string,
  privacyNoticeText: string,
  loadingText: string,
  processingPaymentText: string,
  redirectedToNewTabText: string,
