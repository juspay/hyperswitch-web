let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  selectNamedPaymentMethodLabel: name => `Zahlungsmethode ${name} auswählen`,
  ...
  paymentDetailsFormLabel: "Formular für Zahlungsdetails",
  goBackLabel: "Zurück",
  openBankAccountOptionsLabel: "Bankkonto-Optionen öffnen",
  addBankAccountLabel: "Klicken, um ein Bankkonto hinzuzufügen",
  toggleInstallmentOptionsLabel: "Ratenplanoptionen umschalten",
  savePaymentMethodLabel: "Zahlungsmethode speichern",
  deletePaymentMethodLabel: "Zahlungsmethode löschen",
  managePaymentMethodsLabel: "Zahlungsmethoden verwalten",
  selectPaymentMethodLabel: "Zahlungsmethode auswählen",
  doneLabel: "Fertig",
  selectCardLabel: (nickname, last4) => `Karte ${nickname} mit Endung ${last4} auswählen`,
  selectInstallmentPlanLabel: count => `Ratenplan mit ${count} Raten auswählen`,
}
