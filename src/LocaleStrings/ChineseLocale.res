let localeStrings: LocaleStringTypes.localeStrings = {
  ...
  phoneInvalidText: `请输入有效的电话号码`,
  blikCodeInvalidText: `请输入有效的 6 位 Blik 代码`,
  ...
  selectNamedPaymentMethodLabel: name => `选择 ${name} 支付方式`,
  processingPaymentText: "正在处理付款",
  paymentFailedText: "付款失败，请检查您的信息后重试。",
  paymentDetailsFormLabel: "付款详情表单",
  goBackLabel: "返回",
  openBankAccountOptionsLabel: "打开银行账户选项",
  addBankAccountLabel: "点击添加银行账户",
  toggleInstallmentOptionsLabel: "切换分期付款计划选项",
  savePaymentMethodLabel: "保存支付方式",
  deletePaymentMethodLabel: "删除支付方式",
  managePaymentMethodsLabel: "管理支付方式",
  selectPaymentMethodLabel: "选择支付方式",
  doneLabel: "完成",
  selectCardLabel: (nickname, last4) => `选择尾号 ${last4} 的 ${nickname} 卡`,
  selectInstallmentPlanLabel: count => `选择 ${count} 期分期付款计划`,
}
