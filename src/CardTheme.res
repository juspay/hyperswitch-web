...
let itemToObjMapper = (
  ...
  )
  {
    ...
    subscriptionSecret: getWarningString(dict, "subscriptionSecret", "", ~logger),
    initSubscriptionsFlow: getWarningBool(dict, "initSubscriptionsFlow", false, ~logger),
