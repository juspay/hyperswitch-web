// Stripe non-3DS card flow end to end: a successful payment plus client-side
// validation errors.
//
...
const body = paymentBody({ customer_id: "new_user" });

test.describe("Stripe non-3DS card flow", () => {
