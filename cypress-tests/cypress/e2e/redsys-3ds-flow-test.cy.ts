...
describe("External 3DS using Redsys flow test", () => {
    ...
    changeObjectKeyValue(createPaymentBody, "profile_id", connectorProfileIdMapping.get(connectorEnum.REDSYS));
    ...
    it("3ds invoke: frictionless flow", () => {
        ...
        getIframeBody().get("#submit").click();
        cy.contains("Thanks for your order!", { timeout: 16000 }).should("be.visible");
    });
