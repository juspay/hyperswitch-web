...
describe("Element Lifecycle Tests", () => {
  ...
  it("should verify iframe communication works", () => {
    ...
    getIframeBody().find(`[data-testid=${testIds.cardNoInputTestId}]`, { timeout: 10000 }).should("be.visible");
  ...
  it("should handle multiple elements on same page", () => {
    ...
    getIframeBody().find(`[data-testid=${testIds.cardNoInputTestId}]`, { timeout: 10000 }).should("have.length", 1);
  });
