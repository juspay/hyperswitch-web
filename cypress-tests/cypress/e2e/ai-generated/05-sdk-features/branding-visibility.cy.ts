...
describe("PaymentElement branding Option", () => {
  ...
  describe('branding: "auto" (default)', () => {
    ...
    it("should display the Hyperswitch branding icon", () => {
      // The PoweredBy component renders a div with text-center containing an SVG
      // The SVG references the "powerd-by-hyper" icon via xlink:href
      getIframeBody()
  ...
  describe('branding: "never"', () => {
    ...
    it("should hide the Hyperswitch branding icon", () => {
      // When branding is "never", no SVG with powerd-by-hyper should exist
